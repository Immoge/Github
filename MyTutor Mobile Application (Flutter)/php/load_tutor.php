...
$sqltutors = "SELECT`tbl_tutors`.`tutor_id`, `tbl_tutors`.`tutor_email`, `tbl_tutors`.`tutor_phone`, `tbl_tutors`.`tutor_name`, `tbl_tutors`.`tutor_description`, `tbl_tutors`.`tutor_datereg`, group_concat(Distinct tbl_subjects.subject_name SEPARATOR '\n') AS `tutor_course`
FROM `tbl_tutors` 
