...
class _CourseScreenState extends State<CourseScreen> {
                                            ...
                                            children: [
                                              Expanded(
                                                ...
                                                child: Column(children: [
                                                  Text(
                                                    "Price: RM${double.parse(courseList[index].coursePrice.toString()).toStringAsFixed(2)}",
                                                    textAlign: TextAlign.left,
                                                  ),
                                                  Text(
                                                    "Sessions: ${courseList[index].courseSession}",
                                                    textAlign: TextAlign.left,
                                                  ),
                                                  Text(
                                                    "Rating: ${courseList[index].courseRating}",
                                                    textAlign: TextAlign.left,
                                                  ),
                                                ]),
                                              ),
  ...
  void _loadCourses(int pageno, String search) {
    curpage = pageno;
    numofpage ?? 1;
    http.post(
